...
export const TECHS: TechDef[] = [
  ...
  },
  {
    id: 'armada_tactics',
    name: '联合舰队战术',
    desc: '以王庭舰队为假想敌演进而成的星臂级联合作战体系，部队攻击与防御 +25%',
    branch: 'military',
    icon: 'i-tech-armada',
    tier: 7,
  ...
  },
  {
    id: 'galaxy_command',
    name: '星河统帅',
    desc: '以帝庭舰队为假想敌演进而成的星系级作战体系，部队攻击与防御 +25%',
    branch: 'military',
  ...
  },
  {
    id: 'dark_web',
    name: '暗物质星网',
    desc: '沿银河中继链铺设的暗物质采集网络，暗物质产出 +30%',
    branch: 'dark',
  ...
  },
  {
    id: 'void_command',
    name: '虚空统帅',
    desc: '以虚空巨兽与裁决军团为假想敌演进而成的深空作战体系，部队攻击与防御 +25%',
    branch: 'military',
  ...
  },
  {
    id: 'dark_veil',
    name: '暗幕收集网',
    desc: '铺设在静默星幕边缘的暗物质收集网络，暗物质产出 +30%',
    branch: 'dark',
  ...
  },
  {
    id: 'void_archive',
    name: '深空记忆库',
    desc: '接入门后回响的记忆库，收录先驱者出航前的全部档案，数据产出 +40%',
    branch: 'computing',
    icon: 'i-tech-data-5',
    tier: 9,
