...
export default {
  ...
  'offline.gainBuildings': 'Building production',
  'offline.gainDeepSpace': 'Deep-space events',
  'offline.gainGarrison': 'Garrison earnings',
  'offline.gainTraining': 'Unit training completed',
  'offline.gone': 'You were away for',
