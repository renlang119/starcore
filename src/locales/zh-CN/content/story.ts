...
export default {
  ...
  'content.story.node_deep': '虫洞的另一端，沉默者的舰队正在等待。他们的沉默，即将被打破。',
  ...
  'content.story.node_inner': '内层行星表面布满了晶体矿脉，但深处传来未知的生物信号。',
  'content.story.node_orbit': '扫描器在轨道残骸带中发现了掠夺者的踪迹。他们似乎在寻找什么……',
  'content.story.node_outer':
    '气态巨行星的卫星上发现了古代遗迹。遗迹深处，一个声音在低语：「他们来了。」',
